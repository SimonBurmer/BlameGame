...
def reset_room(room: Room) -> None:
    ...
    Same room code, same players and photos, same host — only rounds and
    scores are cleared, so the group can play again without re-sharing the
    code or re-uploading photos.
    """
